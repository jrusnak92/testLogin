...
header("location: http://www.generalpolar.com/root");
    exit();
}
$notification_list = "";
...
<style type="text/css">
div#notesBox{float:left; width:350px; border:#F0F 1px dashed; margin-right:60px; padding:10px;}
div#friendReqBox{float:left; width:350px; border:#F0F 1px dashed; padding:10px;}
