...
// This block deletes all accounts that do not activate after 7 days
$sql = "SELECT id, username FROM users WHERE signup<=CURRENT_DATE - INTERVAL 7 DAY AND activated='0'";
